...
export default function BestNightsOfMonth({ location, weather, target }) {
  const topNights = useMemo(() => {
    const nights = computeForecast(weather, location.latitude, location.longitude, 15, location.population, target)
