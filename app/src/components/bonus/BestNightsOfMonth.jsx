...
export default function BestNightsOfMonth({ location, weather }) {
  const topNights = useMemo(() => {
    const nights = computeForecast(weather, location.latitude, location.longitude, 15)
  ...
  return (
    <div className="card">
      ...
      <p className="text-xs text-muted mb-4">
        Sur les 15 prochains jours — c'est la limite des prévisions météo gratuites disponibles.
      </p>
